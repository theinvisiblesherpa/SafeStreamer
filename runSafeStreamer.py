...
st.markdown("Please rate the following movies on a scale from 1 to 5 stars. Select your preferred genres and select the content you wish to avoid in the sidebar. Finally, click the button below and receive your recommendations!")
